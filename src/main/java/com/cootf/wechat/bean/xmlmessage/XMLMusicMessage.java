package com.cootf.wechat.bean.xmlmessage;

import com.cootf.wechat.bean.message.message.Message;
import com.cootf.wechat.bean.message.message.MusicMessage;
import com.cootf.wechat.bean.message.message.MusicMessage.Music;

...
import com.cootf.wechat.bean.card.CardType;
import com.cootf.wechat.bean.card.CashCard;
import com.cootf.wechat.bean.card.DiscountCard;
import com.cootf.wechat.bean.card.GeneralCouponCard;
import com.cootf.wechat.bean.card.GiftCard;
import com.cootf.wechat.bean.card.GrouponCard;
import com.cootf.wechat.bean.card.batchget.BatchGet;
import com.cootf.wechat.bean.card.batchget.BatchGetResult;
import com.cootf.wechat.bean.card.code.checkcode.CodeCheckCode;
import com.cootf.wechat.bean.card.code.checkcode.CodeCheckCodeResult;
import com.cootf.wechat.bean.card.code.consume.CodeConsume;
import com.cootf.wechat.bean.card.code.consume.CodeConsumeResult;
import com.cootf.wechat.bean.card.code.decrypt.CodeDecrypt;
import com.cootf.wechat.bean.card.code.decrypt.CodeDecryptResult;
import com.cootf.wechat.bean.card.code.deposit.CodeDeposit;
import com.cootf.wechat.bean.card.code.deposit.CodeDepositResult;
import com.cootf.wechat.bean.card.code.get.CodeGet;
import com.cootf.wechat.bean.card.code.get.CodeGetResult;
import com.cootf.wechat.bean.card.code.getdepositcount.CodeGetDepositCount;
import com.cootf.wechat.bean.card.code.getdepositcount.CodeGetDepositCountResult;
import com.cootf.wechat.bean.card.code.unavailable.CodeUnavailable;
import com.cootf.wechat.bean.card.code.update.CodeUpdate;
import com.cootf.wechat.bean.card.create.Create;
import com.cootf.wechat.bean.card.create.CreateResult;
import com.cootf.wechat.bean.card.get.AbstractResult;
import com.cootf.wechat.bean.card.get.GetCashResult;
import com.cootf.wechat.bean.card.get.GetDiscountResult;
import com.cootf.wechat.bean.card.get.GetGeneralCouponResult;
import com.cootf.wechat.bean.card.get.GetGrouponResult;
import com.cootf.wechat.bean.card.get.GetResult;
import com.cootf.wechat.bean.card.landingpage.create.LandingPageCreate;
import com.cootf.wechat.bean.card.landingpage.create.LandingPageCreateResult;
import com.cootf.wechat.bean.card.modifystock.ModifyStock;
import com.cootf.wechat.bean.card.mpnews.gethtml.MpNewsGetHtml;
import com.cootf.wechat.bean.card.mpnews.gethtml.MpNewsGetHtmlResult;
import com.cootf.wechat.bean.card.paycell.set.PaySellSet;
import com.cootf.wechat.bean.card.qrcode.create.QrCodeCreate;
import com.cootf.wechat.bean.card.qrcode.create.QrCodeCreateMultiple;
import com.cootf.wechat.bean.card.qrcode.create.QrCodeCreateResult;
import com.cootf.wechat.bean.card.testwhitelist.set.TestWhiteListSet;
import com.cootf.wechat.bean.card.update.UpdateCash;
import com.cootf.wechat.bean.card.update.UpdateDiscount;
import com.cootf.wechat.bean.card.update.UpdateGeneralCoupon;
import com.cootf.wechat.bean.card.update.UpdateGift;
import com.cootf.wechat.bean.card.update.UpdateGroupon;
import com.cootf.wechat.bean.card.update.UpdateResult;
import com.cootf.wechat.bean.card.user.getcardlist.UserGetCardList;
import com.cootf.wechat.bean.card.user.getcardlist.UserGetCardListResult;

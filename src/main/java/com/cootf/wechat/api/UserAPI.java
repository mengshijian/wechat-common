...
import com.cootf.wechat.bean.user.FollowResult;
import com.cootf.wechat.bean.user.GetblacklistResult;
import com.cootf.wechat.bean.user.Group;
import com.cootf.wechat.bean.user.TagsCreatResult;
import com.cootf.wechat.bean.user.TagsGetResult;
import com.cootf.wechat.bean.user.TagsGetidlistResult;
import com.cootf.wechat.bean.user.User;
import com.cootf.wechat.bean.user.UserInfoList;
import com.cootf.wechat.bean.user.UserTagGetResult;
import com.cootf.wechat.client.LocalHttpClient;
import com.cootf.wechat.util.EmojiUtil;

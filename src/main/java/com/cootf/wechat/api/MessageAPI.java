...
import com.cootf.wechat.bean.media.Media;
import com.cootf.wechat.bean.message.ApiAddTemplateResult;
import com.cootf.wechat.bean.message.Article;
import com.cootf.wechat.bean.message.CurrentAutoreplyInfo;
import com.cootf.wechat.bean.message.GetAllPrivateTemplateResult;
import com.cootf.wechat.bean.message.GetIndustryResult;
import com.cootf.wechat.bean.message.MessageSendResult;
import com.cootf.wechat.bean.message.Uploadvideo;
import com.cootf.wechat.bean.message.massmessage.MassMessage;
import com.cootf.wechat.bean.message.message.Message;
import com.cootf.wechat.bean.message.preview.Preview;
import com.cootf.wechat.bean.message.templatemessage.TemplateMessage;
import com.cootf.wechat.bean.message.templatemessage.TemplateMessageResult;
import com.cootf.wechat.bean.message.templatemessage.WxopenTemplateMessage;
